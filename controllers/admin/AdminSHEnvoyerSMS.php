...
class AdminSHEnvoyerSMSController extends AdminSHAdminController
{
    ...
    public function setMedia($isNewTheme = false)
    {
        ...
        $this->addJS(_MODULE_DIR_.'tunisiesms/views/js/envoyersms.js');
    }
